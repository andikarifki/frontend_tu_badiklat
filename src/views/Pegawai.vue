            ...
            >
              ...
              <td class="px-6 py-5">
                <div class="flex items-center gap-4">
                  <div
                    class="h-10 w-10 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-700 font-bold text-xs shrink-0"
                  >
                    {{
                      p.nama
                        .split(" ")
              ...
              <td class="px-6 py-5 whitespace-normal max-w-[200px]">
              ...
              <td class="px-6 py-5 text-center">
                <div class="flex justify-center items-center gap-1">
                  <button
                    @click="lihatDetail(p)"
                    class="p-2 text-slate-400 hover:text-emerald-600 hover:bg-emerald-50 rounded-lg transition-all group/btn"
                    title="Lihat Detail"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex flex-col md:flex-row gap-8 items-start">
          <div class="w-full md:w-1/3 flex flex-col items-center">
            <div class="relative group">
              ...
              <div
                class="absolute -bottom-2 -right-2 bg-emerald-500 text-white text-[10px] font-bold px-3 py-1 rounded-full shadow-lg uppercase"
              >
                Aktif
              </div>
            </div>
            <p
              class="mt-4 text-xs text-slate-400 font-medium italic text-center"
            >
...
const dataPegawai = ref([
  {
    nama: "RINTO GUNAWAN SITORUS",
    nip: "198208292008011001",
    pangkat: "Pembina",
    golongan: "IV/a",
    jabatan: "Kepala Balai Pendidikan dan Pelatihan Hukum Jawa Tengah",
  },
  {
    nama: "ANITA DWI FATMANINGRUM",
    nip: "198601172009122006",
    pangkat: "Penata Tk. I",
    golongan: "III/d",
    jabatan: "Kepala Sub Bagian Tata Usaha",
  },
  {
    nama: "RANID PETRA ZUDHA",
    nip: "198912032019011001",
...
const tambahPegawai = () => {
  alert("Fungsi tambah pegawai akan terbuka!");
};
</script>
