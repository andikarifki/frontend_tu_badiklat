...
// Mendefinisikan props dan emits
const props = defineProps(["modelValue"]); // modelValue untuk sync status collapse ke parent
const emit = defineEmits(["update:modelValue", "logout"]);

const isCollapsed = ref(false);

// Mengirim status collapse ke parent agar margin main content ikut berubah
watchEffect(() => {
